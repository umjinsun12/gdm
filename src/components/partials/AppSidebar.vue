<template lang="html">
  ...
  <section class="app-sidebar">
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        <li class="nav-item"><router-link class="nav-link" to="/"><img class="menu-icon" src="../../assets/images/menu_icons/01.png" alt="menu icon"><span class="menu-title">Home</span></router-link></li>
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'sample-pages'">
            <img class="menu-icon" src="../../assets/images/menu_icons/08.png" alt="menu icon"><span class="menu-title">Cohort analysis</span><i class="menu-arrow"></i>
          </span>
          <b-collapse id="sample-pages">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><router-link class="nav-link" to="/">test</router-link></li>
              <li class="nav-item"><router-link class="nav-link" to="/">test</router-link></li>
              <li class="nav-item"><router-link class="nav-link" to="/">test</router-link></li>
              <li class="nav-item"><router-link class="nav-link" to="/">test</router-link></li>
            </ul>
        ...
        <li class="nav-item">
          <span class="nav-link" v-b-toggle="'ui-components'">
            <img class="menu-icon" src="../../assets/images/menu_icons/03.png" alt="menu icon"><span class="menu-title">Individual analysis</span><i class="menu-arrow"></i>
          </span>
